...
if(isset($_GET['page'],$_GET['project_id']) && $_GET['page'] == 'search_query') {
	...
	$project = $database->fetch_array($result);
	...
	$html .= '
		...
		<h1> - Project\'s Detail - </h1>
    	<h2 style="  "> 
			Detail of Project <span>( '. $project["project_title"] .' )</span> which is of <span>( '. $project["organization"] .' ) Organization</span> 
		</h2>
	...
	// This method has several options, check the source code documentation for more information.
	$pdf->Output('Project_detail.pdf', 'I');
