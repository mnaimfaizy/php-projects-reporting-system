...
/* ---------------------------------------------- Report of Search Query -------------------------------------- */
	...
	$pdf->SetSubject('Reports of all Clients');
	$pdf->SetKeywords('Clients, list, report, PDF, pdf');
	...
	$html = '
        ...
        <table style="width: 100%; border: 1px solid #B3B3B3;" cellpadding="4" cellspacing="4">
        	<tr style="border: 1px solid #009BFF; background-color: #009BFF; color: #FFFFFF;">
                ...
                <th style="width:20%;"> Client/Organization</th>
                <th style="width:10%;"> Organization Type </th>
	...
	while($clients = $database->fetch_array($result)) {
	   
       $html .= '<tr>
            	<td style="width:10%;"> '. $no++ .' </td>
                <td style="width:20%;"> '. $clients['client_organization'] .' </td>
                <td style="width:10%;"> '. $clients['organization_type'] .' </td>
                <td style="width:20%;"> '. $clients['address'] .' </td>
                <td style="width:20%;"> '. $clients['telephone'] .' </td>
                <td style="width:20%;"> '. $clients['email'] .' </td>
            </tr>
			<tr>
