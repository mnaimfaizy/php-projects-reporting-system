...
$db = "projects"; // your MySQL database name
$mysql_username = "root";  // your MySQL username
$mysql_password = "";  // your MySQL password

$from_emailaddress = "mnaimfaizy@yahoo.com";// your email address to show who the email is from (should be different $to_emailaddress)
$report_emailaddress = "mnaimfaizy@mnfprofile.com";//address to send reports, not the backup just details on last backups (can be same as above)
$to_emailaddress = "mnaimfaizy@mnfprofile.com"; // your email address to send backup files to
