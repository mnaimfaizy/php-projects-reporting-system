...
function docReady() {
    ...
    if ($('.tour').length && typeof(tour) == 'undefined') {
        ...
        tour.addStep({
            ...
            placement: "top",
            title: "Take Tour", /* title of the popover */
            content: "This is a simple tour of the current application. Click Next." /* content of the popover */
        });
        tour.addStep({
		...
		tour.addStep({
            element: "#project",
            title: "Projects",
            content: "This is project area, here you can add or view projects."
        });
		tour.addStep({
            element: "#report",
            title: "Reports",
            content: "This is report area, here you can view reports from entered data."
        });
        tour.addStep({
            element: "#for-is-ajax",
            title: "Ajax",
